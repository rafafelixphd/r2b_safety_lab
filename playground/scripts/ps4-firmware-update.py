import argparse
from r2b.video.ps4.firmware import PS4EyeFirmware, PS4EyeFirmwareData, ps4_cuh_zeh1, ps4_cuh_zeh2, unknown_dev
...
if __name__ == "__main__":
    ...
    parser.add_argument('--interface', type=id2interface, help='PS4 Eye interface', default=unknown_dev)
